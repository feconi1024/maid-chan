...
def build_memory_context(
    ...
    *,
    ...
    return (
        ...
        "describes. A subject whose id is 'master' is the configured operator; "
        "use its display_name as profile data when present, without overriding "
        "the runtime's configured form of address. "
